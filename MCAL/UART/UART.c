 ...
 *
 **/
ERR_STATUS UART_Init(UART_cfg_s *pUART_cfg_s)
{
 ...
 *
 **/
ERR_STATUS UART_SendByte(uint8 u8_Data)
{
 ...
 *
 **/
ERR_STATUS UART_ReceiveByte(uint8 *pu8_ReceivedData)
{
