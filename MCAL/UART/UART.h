 ...
 *
 **/     
extern ERR_STATUS UART_Init(UART_cfg_s *pUART_cfg_s);
 ...
 *
 **/     
extern ERR_STATUS UART_Deinit(void);
 ...
 *
 **/
extern ERR_STATUS UART_SendByte(uint8 u8_Data);
 ...
 *
 **/  
extern ERR_STATUS UART_ReceiveByte(uint8 *pu8_ReceivedData);
